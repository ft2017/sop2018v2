...
//            echo "<div class='sop_cat'>$cat$val   <a class='btn btn-primary' href='sop/ver01/$cat$val.xml'>查看或下載原代碼</a></div>";
...
//         echo "</ul>";
        ...
        foreach ($arr as $key => $val) {
            ...
            echo "<h3>$cat$val  <a class='btn btn-primary' href='sop/ver01/$cat$val.xml'>查看或下載原代碼</a></h3>";
